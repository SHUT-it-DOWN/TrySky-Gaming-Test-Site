            ...
            $.each(data, function(originalClassName, data) {
                ...
                $.each(data, function(classSpec, classData) {
                    ...
                    $.each(classData, function(originalSpecName, specData) {
                        ...
                        // Append Useful Links
                        $(`#specs > #${className} > #${specName} > .specLinks`).append(`<a href='https://www.wowhead.com/guide/classes/${urlClass}/${urlSpec}/overview-pve-${urlClassType}#overview' target='_blank'><li class='link'>Overview</li></a>`);
                        $(`#specs > #${className} > #${specName} > .specLinks`).append(`<a href='https://www.wowhead.com/guide/classes/${urlClass}/${urlSpec}/abilities-talents-pve-${urlClassType}#baseline-spells' target='_blank'><li class='link'>Abilities</li></a>`);
                        $(`#specs > #${className} > #${specName} > .specLinks`).append(`<a href='https://www.wowhead.com/guide/classes/${urlClass}/${urlSpec}/rotation-cooldowns-pve-${urlClassType}#how-to-play-${originalSpecName.replace(" ", "-").toLowerCase()}' target='_blank'><li class='link'>Rotation</li></a>`);
                        ...
                        $(`#specs > #${className} > #${specName} > .specLinks`).append(`<a href='https://www.wowhead.com/guide/classes/${urlClass}/${urlSpec}/talent-builds-pve-${urlClassType}#mythic-builds' target='_blank'><li class='link'>M+ Talents</li></a>`);
                        $(`#specs > #${className} > #${specName} > .specLinks`).append(`<a href='https://www.wowhead.com/guide/classes/${urlClass}/${urlSpec}/talent-builds-pve-${urlClassType}#raid-builds' target='_blank'><li class='link'>Raid Talents</li></a>`);
                        ...
                        $(`#specs > #${className} > #${specName} > .specLinks`).append(`<a href='https://www.wowhead.com/guide/classes/${urlClass}/${urlSpec}/enchants-gems-pve-${urlClassType}#gems-enchants' target='_blank'><li class='link'>Enchantments</li></a>`);
